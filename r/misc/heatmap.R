# heatmap.R
# A general script to build a heatmap using ggdendro and ggplot2
...
data <- read.delim("~/Desktop/sample_data.tsv", check.names=FALSE)
...
# Set row names as the first column in data
rownames(mat) <- data[, 1]
...
# Plot together
pl <- grid.arrange(blank, dendro.t, dendro.l, hm, ncol=2, padding=0, widths=c(1,4))
