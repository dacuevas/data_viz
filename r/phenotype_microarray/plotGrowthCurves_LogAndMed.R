...
#pl + geom_line(size=1) + geom_point(data=meltDataMed, size=1, colour="indianred") + facet_wrap(~main_source + substrate, ncol=12) + coord_trans(y="log2") +
...
theme(axis.text.x=element_text(angle=90, hjust=1, vjust=0.5, colour="black"), panel.background=element_blank(),
    ...
    ggtitle("") + xlab("Time (hours)") + ylab(expression(paste("OD",600[nm], sep=""))) + scale_x_continuous(breaks=c(0.5, 10.0, 20.0, 30.0)) +
